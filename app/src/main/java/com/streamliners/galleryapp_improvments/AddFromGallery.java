...
import com.streamliners.galleryapp_improvments.databinding.DialogFromGalleryBinding;
...
public class AddFromGallery {
    private Context context;
    private AddFromGallery.onCompleteListener listener;
     ...
     * @param listener
     */
    public void show(Context context, String imageUrl, AddFromGallery.onCompleteListener listener){
