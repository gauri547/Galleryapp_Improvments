package com.streamliners.galleryapp_improvments.helper;
...
public class ItemHelper {
    ...
    private ItemHelper.OnCompleteListener listener;
    ...
    private RedirectedURLHelper.OnFetchedUrlListener onFetchedUrlListener;
    ...
    void fetchUrl(String url) throws IOException {
        ...
        new RedirectedURLHelper().fetchRedirectedURL(new RedirectedURLHelper.OnFetchedUrlListener() {
            @Override
    ...
    private void extractLabels() {
        ...
        labeler.process(image)
                ...
                .addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NotNull @NonNull Exception e) {
